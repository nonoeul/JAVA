...
public class MainClass_1 extends JFrame{
	...
	public MainClass_1()
	{
		...
		JPanel p=new JPanel();//일자 배치   // 속성메뉴 만들기
		p.setLayout(new GridLayout(1,5,5,5));// 한줄에 다섯개 
		p.add(b1);
		p.add(b2);
		p.add(b3);
		p.add(b4);
		...
		JPanel p1=new JPanel(); //속성메뉴 만들기
		p1.setLayout(new GridLayout(5,1,5,5));// 뜻: 5줄에 하나씩
		p1.add(b1);
		p1.add(b2);
		p1.add(b3);
		p1.add(b4);
